      ...
      <div className="container grid grid-cols-1 md:grid-cols-4 gap-8">
        <div className="col-span-1">
          ...
          <p className="text-sm text-muted-foreground mb-4">
            Creating a sustainable future through circular economy solutions.
          </p>
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-2">
            ...
            <li>
              <Link to="/input" className="text-sm text-muted-foreground hover:text-foreground">
                List Waste
              </Link>
            </li>
            <li>
        ...
        <div className="col-span-1">
          ...
          <p className="text-sm text-muted-foreground mb-4">
            Subscribe to our newsletter for the latest updates on circular economy innovations.
          </p>
      ...
      <div className="container mt-8 pt-8 border-t border-border">
        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          <p className="text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} Re-Genπ. All rights reserved.
          </p>
          <div className="flex space-x-4">
            <Link to="#" className="text-sm text-muted-foreground hover:text-foreground">
              Privacy Policy
